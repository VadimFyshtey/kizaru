        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
            ...
            <article class="last_info">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="last_news">
                        <p class="text_last_news"><img src="/images/last_news.png" />Последние новости:</p>
                        <?= NewsWidget::widget(['tpl' => 'news']) ?>
                        <p class="all_news_button"><a href="/news">Все новости »</a></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="twitter_iframe">
                        <a class="twitter-timeline" href="https://twitter.com/KIZARU_HF?ref_src=twsrc%5Etfw">Tweets by KIZARU_HF</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="instagramm_iframe">
                        <iframe src='/helper/inwidget/index.php?toolbar=false&inline=2&adaptive=true&view=20' data-inwidget scrolling='no' frameborder='no'></iframe>
                    </div>
                </div>
            </article>
        </div>
